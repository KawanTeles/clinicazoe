    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          rows={rows}
          className={cn(
            "w-full resize-y rounded-xl border border-border bg-card-elevated px-3.5 py-2.5 text-xs font-medium leading-relaxed text-text-primary placeholder:text-text-muted transition-all duration-200 ease-out focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30 focus:shadow-[0_0_15px_rgba(54,99,84,0.15)]",
