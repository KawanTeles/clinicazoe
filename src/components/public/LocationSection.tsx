...
export function LocationSection({ clinicName, address, whatsappNumber }: LocationSectionProps) {
  ...
  return (
    <section id="como-chegar" className="py-20 border-t border-[#255044]/60 bg-[#081C15]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* Left Details Card */}
          <div className="lg:col-span-5 flex flex-col justify-between rounded-3xl border border-[#255044] bg-[#102A22] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)] space-y-6">
            <div className="space-y-6">
              <div>
                <span className="text-xs font-bold uppercase tracking-wider text-[#5ED39D]">Endereço Completo</span>
                <p className="text-base font-bold text-white mt-1 leading-relaxed">{fullAddress}</p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-[#255044]/60 text-xs">
                <div>
                  <span className="text-[#7A9187] font-semibold">Telefone:</span>
                  <p className="text-sm font-bold text-white mt-0.5">(11) 3200-0000</p>
                </div>
                <div>
                  <span className="text-[#7A9187] font-semibold">WhatsApp:</span>
                  <p className="text-sm font-bold text-[#5ED39D] mt-0.5">
                    {whatsappNumber ? `+${whatsappNumber}` : "(11) 99999-9999"}
                  </p>
                </div>
                <div className="sm:col-span-2">
                  <span className="text-[#7A9187] font-semibold">E-mail:</span>
                  <p className="text-sm font-bold text-white mt-0.5">contato@clinicazoe.com.br</p>
                </div>
              </div>

              <div className="pt-4 border-t border-[#255044]/60 space-y-2">
                <span className="text-xs font-bold uppercase tracking-wider text-[#5ED39D]">Horário de Funcionamento</span>
                <div className="text-xs text-[#C8D4CF] space-y-1">
          ...
          {/* Right Map Embed */}
          <div className="lg:col-span-7 rounded-3xl border border-[#255044] overflow-hidden min-h-[350px] lg:min-h-[450px] relative shadow-lg">
            <iframe
