      ...
      <div className={`p-3 bg-card-elevated/20 transition-all duration-300 ${viewMode === "mobile" ? "max-w-[320px] mx-auto" : "w-full"}`}>
        <div className="rounded-xl border border-border/80 bg-card shadow-lg overflow-hidden flex flex-col">
          ...
          <div className="flex items-center justify-between px-3 py-2 bg-card/95 border-b border-border/40 text-xs">
            ...
            <span className="text-[9.5px] font-semibold text-primary">Prévia do Site</span>
          </div>

          {/* Mini Live Site Content Body */}
          <CardContent className="p-3.5 flex flex-col gap-3 bg-background/50">
            {/* Hero Banner Box */}
            ...
            {/* Social links (Positioned prominently before business hours) */}
            ...
            <div className="rounded-xl border border-border/70 bg-card p-3 shadow-xs space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[9.5px] text-text-muted font-medium">Dias & Horários</span>
              </div>

              <div className="flex flex-col divide-y divide-border/30 text-[10.5px]">
                {[...data.business_hours]
                  .sort((a, b) => a.day - b.day)
                  .map((entry) => (
                    <div key={entry.day} className="flex items-center justify-between gap-2 py-1">
                ...
                <div className="flex items-center justify-between gap-2 py-1 pt-1.5">
