          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <ScrollReveal animation="slide-left">
              <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                ...
                <h3 className="text-xl font-bold text-text-primary">Consultórios Climatizados & Acústicos</h3>
            ...
            <ScrollReveal animation="slide-right">
              <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                ...
                <h3 className="text-xl font-bold text-text-primary">Central Diagnóstica Integrada</h3>
                <p className="text-xs sm:text-sm text-text-secondary leading-relaxed">
            ...
            <ScrollReveal animation="slide-left">
              <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                ...
                <h3 className="text-xl font-bold text-text-primary">Biossegurança e Esterilização Rígida</h3>
                <p className="text-xs sm:text-sm text-text-secondary leading-relaxed">
            ...
            <ScrollReveal animation="slide-right">
              <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                ...
                <h3 className="text-xl font-bold text-text-primary">Recepção Premium e Estacionamento</h3>
                <p className="text-xs sm:text-sm text-text-secondary leading-relaxed">
