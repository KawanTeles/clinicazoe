        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <ScrollReveal animation="slide-left">
              <div className="space-y-6">
                <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                  ...
                  <h3 className="text-lg font-bold text-text-primary">Endereço</h3>
                ...
                <div className="rounded-3xl border border-border bg-card p-8 shadow-card space-y-4">
                  ...
                  <h3 className="text-lg font-bold text-text-primary">Horário de Atendimento</h3>
                ...
                {whatsappLink && (
                  <div className="rounded-3xl border border-[#25D366]/40 bg-card p-8 shadow-card space-y-4">
                    <h3 className="text-lg font-bold text-text-primary">Central de WhatsApp</h3>
            ...
            <ScrollReveal animation="slide-right">
              <div className="rounded-3xl border border-border bg-card p-8 sm:p-10 shadow-card text-center space-y-6">
                <Badge tone="success">Agendamento 100% Online</Badge>
                <h3 className="text-2xl font-black text-text-primary">Prefere agendar diretamente?</h3>
