        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <ScrollReveal animation="fade-up">
              <Badge tone="premium">Fale Conosco</Badge>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <ScrollReveal animation="slide-left">
              <div className="space-y-6">
                <div className="rounded-3xl border border-[#255044] bg-[#102A22] p-8 shadow-lg space-y-4">
                  ...
                  <p className="text-sm text-[#C8D4CF] leading-relaxed">
                ...
                <div className="rounded-3xl border border-[#255044] bg-[#102A22] p-8 shadow-lg space-y-4">
                  ...
                  <div className="space-y-1 text-xs text-[#C8D4CF]">
                    <p><strong className="text-white">Segunda a Sexta:</strong> 07:00 às 20:00</p>
                ...
                {clinic.whatsapp_number && (
                  <div className="rounded-3xl border border-[#25D366]/40 bg-[#102A22] p-8 shadow-lg space-y-4">
                    <h3 className="text-lg font-bold text-white">Central de WhatsApp</h3>
                    <p className="text-xs text-[#C8D4CF]">
                      Tire suas dúvidas ou solicite informações diretamente no nosso canal oficial.
                    </p>
                    <a
                      href={`https://wa.me/${clinic.whatsapp_number}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-6 py-3.5 text-sm font-bold text-white transition-all hover:bg-[#1EBE5A] shadow-[0_10px_30px_rgba(37,211,102,0.3)] w-full"
                    >
            ...
            <ScrollReveal animation="slide-right">
              <div className="rounded-3xl border border-[#255044] bg-[#102A22] p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] text-center space-y-6">
                <Badge tone="success">Agendamento 100% Online</Badge>
                <h3 className="text-2xl font-black text-white">Prefere agendar diretamente?</h3>
                ...
                <div className="pt-4">
                  <Link href="/cliente/login">
                    <Button size="lg" className="w-full font-bold py-4">
