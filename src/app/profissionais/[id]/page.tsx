      ...
      <main className="flex-1 py-16 lg:py-24">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <ScrollReveal animation="fade-up">
            <div className="rounded-3xl border border-border bg-card p-8 sm:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.4)] space-y-8">
              <div className="flex flex-col sm:flex-row items-center gap-8 border-b border-border/60 pb-8">
                ...
                <div className="space-y-2 text-center sm:text-left">
                  ...
                  <h1 className="tracking-hero text-2xl sm:text-3xl font-black text-text-primary">{prof.fullName}</h1>
              ...
              <div className="space-y-6">
                <div>
                  <h2 className="text-sm font-bold text-text-primary uppercase tracking-wider mb-2">Sobre o Profissional</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-border/60">
                  <div className="p-4 rounded-2xl bg-card-elevated/70 border border-border/60">
                    ...
                    <p className="text-base font-bold text-text-primary mt-1">{prof.consultationDuration} minutos</p>
                  </div>
                  {prof.priceParticularPix && (
                    <div className="p-4 rounded-2xl bg-card-elevated/70 border border-border/60">
                      <span className="text-xs text-text-muted">Valor Particular (Pix)</span>
                      <p className="text-base font-bold text-[var(--link)] mt-1">{formatCurrency(prof.priceParticularPix)}</p>
                    </div>
                  )}
                </div>
              </div>
